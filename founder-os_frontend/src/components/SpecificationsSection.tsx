...
export default function SpecificationsSection({ selectedEnquiry, onOpenLightbox }: SpecificationsSectionProps) {
 ...
 <p className="text-xs md:text-sm text-[var(--text-primary)] font-medium whitespace-pre-wrap leading-relaxed bg-[var(--bg-input)]/25 p-3.5 rounded-xl border border-[var(--border-card)]/50">
 ...
 {/* Render Image 1 */}
 <div 
 className="relative w-32 h-32 md:w-36 md:h-36 rounded-xl overflow-hidden border border-[var(--border-card)] group cursor-zoom-in bg-[var(--bg-card)] dark:bg-white/5 flex-shrink-0"
 ...
 <svg className="w-5 h-5 text-[var(--text-primary)] opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
 ...
 <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-[var(--text-primary)] transition-all duration-200 group-hover:bg-black/50 select-none">
 <span className="text-xl font-extrabold tracking-tight">+{selectedEnquiry.imageUrls.length - 3}</span>
 <span className="text-[9px] font-bold uppercase tracking-wider text-[var(--text-secondary)] mt-0.5">drawings</span>
 </div>
 ) : (
 <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 flex items-center justify-center transition-all duration-200">
 <svg className="w-5 h-5 text-[var(--text-primary)] opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
