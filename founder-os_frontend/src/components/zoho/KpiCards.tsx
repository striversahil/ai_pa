  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="group relative overflow-hidden bg-zinc-900 border border-zinc-800/80 rounded-xl p-4 shadow-sm hover:border-indigo-500/40 hover:shadow-lg hover:shadow-indigo-500/5 hover:-translate-y-0.5 transition-all duration-300">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <span className="text-2xl font-bold text-white block">{totalCount}</span>
            </div>
        ...
        <div className="group relative overflow-hidden bg-zinc-900 border border-zinc-800/80 rounded-xl p-4 shadow-sm hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/5 hover:-translate-y-0.5 transition-all duration-300">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <span className="text-2xl font-bold text-white block">₹{totalValue.toLocaleString()}</span>
            </div>
        ...
        <div className="group relative overflow-hidden bg-zinc-900 border border-zinc-800/80 rounded-xl p-4 shadow-sm hover:border-rose-500/40 hover:shadow-lg hover:shadow-rose-500/5 hover:-translate-y-0.5 transition-all duration-300">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
        {kpiCards.map((k) => {
          ...
          const ring = active ? ACCENT_RINGS[k.accent] || ACCENT_RINGS.indigo : "border-zinc-800/80 hover:border-zinc-700";
          return (
            <button
              key={k.field}
              type="button"
              ...
              className={`group relative overflow-hidden bg-zinc-900 border rounded-xl p-2.5 text-left shadow-sm transition-all duration-200 cursor-pointer ${ring} ${active ? "bg-zinc-900" : "hover:-translate-y-0.5"}`}
            >
              <div className="flex items-center justify-between gap-2">
                <span className="text-base font-bold text-white leading-none">{k.count}</span>
              ...
              <span className="block text-[10px] text-zinc-400 font-semibold mt-1 leading-tight">
                {isInverted ? k.negLabel : k.label}
              </span>
              <span className="block text-[9px] text-zinc-600 mt-0.5 font-medium">
