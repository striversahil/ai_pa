...
export default function KpiCards({
 ...
 <div className="group relative overflow-hidden bg-[var(--bg-card)] border border-[var(--border-card)] rounded-xl p-4 shadow-sm hover:border-indigo-500/40 hover:shadow-lg hover:shadow-indigo-500/5 hover:-translate-y-0.5 transition-all duration-300">
 <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-indigo-500 to-violet-500" />
 <div className="flex items-start justify-between">
 <div>
 <span className="text-xs text-[var(--text-tertiary)] block mb-1">Active Sent Estimates</span>
 <span className="text-2xl font-bold text-[var(--text-primary)] block">{totalCount}</span>
 </div>
 ...
 <div className="group relative overflow-hidden bg-[var(--bg-card)] border border-[var(--border-card)] rounded-xl p-4 shadow-sm hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/5 hover:-translate-y-0.5 transition-all duration-300">
 <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-500" />
 <div className="flex items-start justify-between">
 <div>
 <span className="text-xs text-[var(--text-tertiary)] block mb-1">Cumulative Value</span>
 <span className="text-2xl font-bold text-[var(--text-primary)] block">₹{totalValue.toLocaleString()}</span>
 </div>
 ...
 <div className="group relative overflow-hidden bg-[var(--bg-card)] border border-[var(--border-card)] rounded-xl p-4 shadow-sm hover:border-rose-500/40 hover:shadow-lg hover:shadow-rose-500/5 hover:-translate-y-0.5 transition-all duration-300">
 <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-rose-500 to-orange-500" />
 <div className="flex items-start justify-between">
 <div>
 <span className="text-xs text-[var(--text-tertiary)] block mb-1">Not Answering</span>
 ...
 const ring = active ? ACCENT_RINGS[k.accent] || ACCENT_RINGS.indigo : "border-[var(--border-card)] hover:border-black/15 dark:hover:border-white/15";
 return (
 <button
 key={k.field}
 type="button"
 ...
 className={`group relative overflow-hidden bg-[var(--bg-card)] border rounded-xl p-2.5 text-left shadow-sm transition-all duration-200 cursor-pointer ${ring} ${active ? "bg-[var(--bg-card)]" : "hover:-translate-y-0.5"}`}
 >
 <div className="flex items-center justify-between gap-2">
 <span className="text-base font-bold text-[var(--text-primary)] leading-none">{k.count}</span>
 ...
 <span className="block text-[10px] text-[var(--text-tertiary)] font-semibold mt-1 leading-tight">
 {isInverted ? k.negLabel : k.label}
 </span>
 <span className="block text-[9px] text-[var(--text-tertiary)] mt-0.5 font-medium">
