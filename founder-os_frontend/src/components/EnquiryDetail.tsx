...
export default function EnquiryDetail({
 ...
 <button onClick={() => setReplyToCommentId(null)} className="text-[var(--text-tertiary)] hover:text-[var(--text-primary)] cursor-pointer font-bold bg-transparent border-0">&times;</button>
 </div>
 )}
 ...
 <button type="button" onClick={() => setCommentImage(null)} className="absolute top-1 right-1 bg-black/75 text-[var(--text-primary)] w-5 h-5 rounded-full flex items-center justify-center text-xs cursor-pointer font-bold border-0">&times;</button>
 </div>
 )}

 <div className="flex justify-between items-center pt-2 border-t border-[var(--border-card)]/50">
 <div className="flex gap-2">
 <label className="p-1.5 text-[var(--text-tertiary)] hover:text-[var(--text-primary)] cursor-pointer rounded-lg bg-[var(--bg-input)]/50 hover:bg-[var(--bg-input)] transition-all">
 ...
 <button type="submit" className="bg-brand-indigo hover:opacity-90 text-[var(--text-primary)] font-bold text-xs px-3.5 py-1.5 rounded-lg shadow-sm transition-all duration-200 cursor-pointer">
