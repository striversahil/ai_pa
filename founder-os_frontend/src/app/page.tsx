...
export default function Home() {
  ...
  // Navigation state
  const [activeView, setActiveView] = useState<"dashboard" | "enquiries" | "detail" | "briefing" | "zoho" | "sheets" | "whatsapp">("dashboard");
    ...
    <div className="flex flex-col md:grid md:grid-cols-[260px_1fr] min-h-screen relative font-sans antialiased text-[var(--text-primary)]">
      ...
      <aside className="hidden md:flex flex-col h-screen sticky top-0 bg-[var(--bg-sidebar)] text-[#a1a1aa] p-6 border-r border-white/5 z-40">
        ...
        <nav className="flex flex-col gap-2 flex-grow">
          ...
          <button 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 text-left cursor-pointer border-0 w-full ${activeView === "briefing" ? "bg-brand-indigo text-white shadow-lg shadow-indigo-600/25" : "hover:bg-white/5 hover:text-white bg-transparent"}`}
            onClick={() => { setActiveView("briefing"); setSelectedEnquiryId(null); }}
            type="button"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <span>Founder AI Assistant</span>
          </button>

          <button 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 text-left cursor-pointer border-0 w-full ${activeView === "zoho" ? "bg-brand-indigo text-white shadow-lg shadow-indigo-600/25" : "hover:bg-white/5 hover:text-white bg-transparent"}`}
            onClick={() => { setActiveView("zoho"); setSelectedEnquiryId(null); }}
            type="button"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span>Zoho Estimates</span>
          </button>

          <button 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 text-left cursor-pointer border-0 w-full ${activeView === "sheets" ? "bg-brand-indigo text-white shadow-lg shadow-indigo-600/25" : "hover:bg-white/5 hover:text-white bg-transparent"}`}
            onClick={() => { setActiveView("sheets"); setSelectedEnquiryId(null); }}
            type="button"
          >
          ...
          <button 
            className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-200 text-left cursor-pointer border-0 w-full ${activeView === "whatsapp" ? "bg-brand-indigo text-white shadow-lg shadow-indigo-600/25" : "hover:bg-white/5 hover:text-white bg-transparent"}`}
            onClick={() => { setActiveView("whatsapp"); setSelectedEnquiryId(null); }}
            type="button"
          >
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[var(--bg-card)] border-t border-[var(--border-card)] flex justify-around items-center z-40 px-2">
        ...
        <button 
          onClick={() => { setActiveView("briefing"); setSelectedEnquiryId(null); }}
          className={`flex flex-col items-center justify-center flex-1 h-full py-1 text-xs font-semibold border-0 bg-transparent cursor-pointer ${activeView === "briefing" ? "text-brand-indigo" : "text-[var(--text-secondary)]"}`}
          type="button"
        >
          <svg className="w-6 h-6 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
        ...
        <button 
          onClick={() => { setActiveView("zoho"); setSelectedEnquiryId(null); }}
          className={`flex flex-col items-center justify-center flex-1 h-full py-1 text-xs font-semibold border-0 bg-transparent cursor-pointer ${activeView === "zoho" ? "text-brand-indigo" : "text-[var(--text-secondary)]"}`}
          type="button"
        >
          <svg className="w-6 h-6 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        ...
        <button 
          onClick={() => { setActiveView("sheets"); setSelectedEnquiryId(null); }}
          className={`flex flex-col items-center justify-center flex-1 h-full py-1 text-xs font-semibold border-0 bg-transparent cursor-pointer ${activeView === "sheets" ? "text-brand-indigo" : "text-[var(--text-secondary)]"}`}
          type="button"
        >
        ...
        <button 
          onClick={() => { setActiveView("whatsapp"); setSelectedEnquiryId(null); }}
          className={`flex flex-col items-center justify-center flex-1 h-full py-1 text-xs font-semibold border-0 bg-transparent cursor-pointer ${activeView === "whatsapp" ? "text-brand-indigo" : "text-[var(--text-secondary)]"}`}
          type="button"
        >
