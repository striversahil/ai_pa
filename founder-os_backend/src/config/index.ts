...
const configSchema = z.object({
  ...
  WA_ENGINE_BASE_URL: z.string().url('WA_ENGINE_BASE_URL must be a valid URL').default('https://waengine.pro/api/v1'),
  WA_ENGINE_API_KEY: z.string().min(1, 'WA_ENGINE_API_KEY is required'),
  ...
  AUTH_PUBLIC_ORIGIN: z.string().optional(),
});
